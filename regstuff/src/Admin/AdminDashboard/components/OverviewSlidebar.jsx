...
export default function OverviewSlidebar() {
    ...
    <React.Fragment>
      ...
      >
        ...
        >
          ...
          <ListItem>
          <a href="/admin/dashboard/overview" target="_self">  <ListItemButton selected variant="soft">
              <ListItemDecorator>
          ...
          <ListItem>
          <a href="/admin/dashboard/orders" target="_self"> <ListItemButton>
              <ListItemDecorator>
          ...
          <ListItem>
            <ListItemButton >
              ...
              <a href="/admin/dashboard/delete" target="_self" > <ListItemContent>DELETE</ListItemContent></a>
            </ListItemButton>
          </ListItem>
        </List>
